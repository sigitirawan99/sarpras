...
export default function RiwayatPengembalianPage() {
  ...
  const [selectedItem, setSelectedItem] =
    useState<PengembalianWithRelations | null>(null);
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50/50">
                <TableHead className="w-45">Tanggal & Kode</TableHead>
            ...
            <TableBody>
              {loading ? (
                ...
                filteredData.map((item) => {
                  const totalItems = item.pengembalian_detail.reduce(
                      ...
                      <TableCell>
                        <div className="flex flex-col gap-1">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge
                              variant="secondary"
                              className="text-[10px] h-5 bg-gray-100"
                            >
                              {totalItems} Unit
                            </Badge>
                          </div>
                          <div className="flex gap-1 flex-wrap">
                            {isMultiCondition ? (
                              ...
                              getConditionBadge(
                                item.pengembalian_detail[0]?.kondisi,
                              )
                            )}
                          </div>
                        </div>
              ...
              <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pb-6 border-b border-gray-100">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-bold text-sm text-gray-900">
                      {formatJakarta(
                        selectedItem.tanggal_kembali_real,
                        "dd MMMM yyyy",
                      )}
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-sm font-black text-gray-900 uppercase tracking-wider">
                    Daftar Barang & Kondisi
                  </h3>
                  <div className="space-y-3">
                    {selectedItem.pengembalian_detail.map((detail, idx) => (
                      <div
                        key={detail.id}
                        className="bg-gray-50 rounded-2xl p-4 border border-gray-100 flex flex-col md:flex-row gap-4"
                      >
                        {detail.foto ? (
